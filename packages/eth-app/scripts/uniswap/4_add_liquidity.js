// Add liquidity 10 STokens and 1 ETH to the exchange (initial ratio 1:100)
...
const addressTo = '0xc17202D7EBA454eE119540175C5eD6C4A154468e' // Token Exchange contract
const ethToAdd = web3.utils.toWei('0.1', 'ether') // Add 0.1 ETH
// txData: data:encodeABI
const tokenExchangeABI =
...
const tokenExchange = new web3.eth.Contract(JSON.parse(tokenExchangeABI))
const tokensToAdd = web3.utils.toWei('10', 'ether') // Add 10 STokens
const minLiquidity = 1
const deadline = Math.floor(Date.now() / 1000) + 300
const encodedABI = tokenExchange.methods.addLiquidity(minLiquidity, tokensToAdd, deadline).encodeABI() // set initial ratio 1:100 ETH:SToken
...
const sendTx = async () => {
  ...
  const txData = {
    ...
    chainId: 4,
    data: encodedABI,
    value: web3.utils.toHex(ethToAdd)
  }
