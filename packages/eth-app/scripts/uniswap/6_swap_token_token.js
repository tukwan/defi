...
const tokenExchange = new web3.eth.Contract(JSON.parse(tokenExchangeABI), addressExchange)
const tokens_bought = web3.utils.toWei('5', 'ether') // 5 LINK
const max_tokens_sold = web3.utils.toWei('20', 'ether') // 20 SToken
const max_eth_sold = web3.utils.toWei('0.1', 'ether') // 0.1 ETH
const deadline = Math.floor(Date.now() / 1000) + 300
const addreesLinkToken = '0x01be23585060835e02b77ef475b0cc51aa1e0709'
const encodedABI = tokenExchange.methods.tokenToTokenSwapOutput(tokens_bought, max_tokens_sold, max_eth_sold, deadline, addreesLinkToken).encodeABI()
